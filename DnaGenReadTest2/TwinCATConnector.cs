...
namespace DnaGenReadTest2
{
    public class TwinCATConnector
    {
        ...
        public uint CreateVariableHandle(string variableName)
        {
            ...
            {
                Console.WriteLine($"Error creating variable handle: {ex.Message}");
                throw;
            }
        }
        ...
        public bool ReadBool(uint handle)
        {
            ...
            {
                Console.WriteLine($"Error reading variable: {ex.Message}");
                return false;
            }
        }
        ...
        public void WriteBool(uint handle, bool value)
        {
            ...
            {
                Console.WriteLine($"Error writing variable: {ex.Message}");
            }
        }
